...
func (x *Node) GetRoute() *Route {
	if x, ok := x.GetConfig().(*Node_Route); ok {
		return x.Route
	}
	return nil
}

func (x *Node) GetTemplate() *Template {
	if x, ok := x.GetConfig().(*Node_Template); ok {
		return x.Template
	}
	return nil
}

func (x *Node) GetSecret() *Secret {
	if x, ok := x.GetConfig().(*Node_Secret); ok {
		return x.Secret
	}
	return nil
}
...
func (x *Node) GetFile() *File {
	if x, ok := x.GetConfig().(*Node_File); ok {
		return x.File
	}
	return nil
}
...
type Node_Route struct {
	Route *Route `protobuf:"bytes,16,opt,name=route,proto3,oneof"`
}

type Node_Template struct {
	Template *Template `protobuf:"bytes,17,opt,name=template,proto3,oneof"`
}

type Node_Secret struct {
	Secret *Secret `protobuf:"bytes,18,opt,name=secret,proto3,oneof"`
}

type Node_File struct {
	File *File `protobuf:"bytes,19,opt,name=file,proto3,oneof"`
}
...
func (*Node_Route) isNode_Config() {}

func (*Node_Template) isNode_Config() {}

func (*Node_Secret) isNode_Config() {}
...
var file_graph_proto_rawDesc = []byte{
	...
	0x64, 0x67, 0x65, 0x73, 0x22, 0x91, 0x05, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a,
	...
	,

...
func (x *PublishesTo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublishesTo) ProtoMessage() {}

func (x *PublishesTo) ProtoReflect() protoreflect.Message {
	mi := &file_graph_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublishesTo.ProtoReflect.Descriptor instead.
func (*PublishesTo) Descriptor() ([]byte, []int) {
	return file_graph_proto_rawDescGZIP(), []int{3}
}

func (x *PublishesTo) GetCodeAdapter() string {
	if x != nil {
...
func (x *Edge) GetPublishesTo() *PublishesTo {
	if x, ok := x.GetType().(*Edge_PublishesTo); ok {
		return x.PublishesTo
	}
	return nil
}
...
type Edge_PublishesTo struct {
	PublishesTo *PublishesTo `protobuf:"bytes,6,opt,name=publishes_to,json=publishesTo,proto3,oneof"`
}

func (*Edge_Provides) isEdge_Type() {}

func (*Edge_PublishesTo) isEdge_Type() {}
...
var file_graph_proto_rawDesc = []byte{
	...
	0x22, 0x30, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x73, 0x54, 0x6f, 0x12,
	0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x64, 0x65, 0x5f, 0x61, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x64, 0x65, 0x41, 0x64, 0x61, 0x70, 0x74,
	0x65, 0x72, 0x22, 0xaa, 0x01, 0x0a, 0x04, 0x45, 0x64, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x2d, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0f, 0x2e, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	0x65, 0x73, 0x48, 0x00, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x73, 0x12, 0x37,
	0x0a, 0x0c, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x73, 0x5f, 0x74, 0x6f, 0x18, 0x06,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x72, 0x61, 0x70, 0x68, 0x2e, 0x50, 0x75, 0x62,
	0x6c, 0x69, 0x73, 0x68, 0x65, 0x73, 0x54, 0x6f, 0x48, 0x00, 0x52, 0x0b, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x73, 0x68, 0x65, 0x73, 0x54, 0x6f, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x42,
...
var file_graph_proto_goTypes = []interface{}{
	...
	(*PublishesTo)(nil),     // 3: graph.PublishesTo
...
var file_graph_proto_depIdxs = []int32{
	...
	3,  // 9: graph.Edge.publishes_to:type_name -> graph.PublishesTo

...
type Node struct {
	...
	Dependencies []*Resource   `protobuf:"bytes,10,rep,name=dependencies,proto3" json:"dependencies,omitempty"`
}
...
func (x *Node) GetDependencies() []*Resource {
	if x != nil {
...
var file_graph_proto_rawDesc = []byte{
	...
	0x64, 0x67, 0x65, 0x73, 0x22, 0xc7, 0x02, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x74, 0x79, 0x48, 0x00, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x36, 0x0a, 0x0c,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x0c, 0x64, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e,
	0x63, 0x69, 0x65, 0x73, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x3a,
...
var file_graph_proto_depIdxs = []int32{
	...
	7, // 6: graph.Node.dependencies:type_name -> resource.Resource
